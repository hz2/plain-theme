var Tie = window.Tie || {};
! function() {
    Tie.define = window.define, window.define = void 0
}(), ! function(e) {
    ...
    var a = function(e, t, n) {
        ...
        c = function(e) {
            return e = e || "", e.replace(/\:\/\/([^\/]+)/, function(e) {
                return e + "/b"
            })
        },
        l = [],
        ...
        p = function(e) {
            var t = n[e],
                i = null;
            return t.__iframeShowAnimation && (i = "-webkit-animation:" + t.__iframeShowAnimation + ";-moz-animation:" + t.__iframeShowAnimation + ";-ms-animation:" + t.__iframeShowAnimation + ";-o-animation:" + t.__iframeShowAnimation + ";animation:" + t.__iframeShowAnimation + ";"), "width:100%;height:100%;border:none;background:none;" + (i ? i : "")
        },
        h = function() {
            var e = setInterval(function() {
                for (var t = 0; t < o.length; t++)
                    if (o[t].readyDone) {
                        e = clearInterval(e), o.shift(), f(1);
                        break
                    }
            }, 200)
        },
            ...
            if (e || !r) {
                ...
                var t = setInterval(function() {
                    for (var e = 0; e < o.length; e++)
                        if (!o[e].readyDone) {
                            t = clearInterval(t), b.call(o[e]), h();
                            break
                        }
                }, 200)
            }
        ...
        g = function(e, t, i) {
            ...
            if (!c) {
                try {
                    ...
                    c = document.createElement("iframe"), c.allowTransparency = !0, c.name = l
                }
                c.frameBorder = 0, c.id = a, c.scrolling = "no", c.style.cssText = p(r)
            }
            if (t) e.appendChild(c);
            else {
                var g = 420,
                    m = 408;
                s.frameSize && (g = s.frameSize.width, m = s.frameSize.height);
                var v = document.getElementById("x-discover" + r);
                v || (v = document.createElement("div"), v.id = "x-discover" + r, v.style.cssText = u(r));
                var y = document.getElementById("x-panel" + r);
                y || (y = document.createElement("div"), y.id = "x-panel" + r, s._panel = y, y.style.cssText = d(g, m)), y.appendChild(c), e.appendChild(v), e.appendChild(y), e.style.display = "none"
            }
            window.postMessage || (o.push(this), f(0))
        },
        m = function(e) {
            var t = "x-URS-iframe" + this.MGID,
                n = document.getElementById(t);
            this._options && this._options.afterSetIframeSrc && this._options.afterSetIframeSrc(n), window.setTimeout(function() {
                this.__loadTime = (new Date).getTime(), this._url_cache.indexOf("?") == -1 ? this._url_cache += "?pkid=" + (this._options.promark || "") + "&product=" + (this._options.product || "") : this._url_cache += "&pkid=" + (this._options.promark || "") + "&product=" + (this._options.product || ""), n.src = this._url_cache
            }.bind(this), 0), this.sto = clearTimeout(this.sto), window._$needUrsBgp && 1 != e && (this.sto = setTimeout(function() {
                this.sto = clearTimeout(this.sto), this._url_cache.indexOf("webzj.reg.163.com") >= 0 && (this._url_cache = this._url_cache.replace("webzj.reg.163.com", "webzj2.reg.163.com"), this._url_cache = this._url_cache.replace(/wdaId=([^&]+)/, "wdaId=UA1482833332087"), m.call(this, 1))
            }.bind(this), 1e4))
        },
        v = function(e) {
            ...
            for (t in n) i.push(r(n[t] + "-" + e));
            i.push(r(e));
            for (t in i)
                if (i[t] in o) return !0;
            return !1
        },
        y = function(e, t) {
            var n = document.getElementById("x-URS-iframe" + e),
                ...
                o = {};
            o.data = t, o.data.from = "URS|", o.origin = "*", o.source = i, o.data.loadTime = (new Date).getTime() - this.__loadTime, x(n.contentWindow, o)
        },
        b = function() {
        ...
        T = function(e, t) {
            try {
                return t = t.toLowerCase(), null === e ? "null" == t : void 0 === e ? "undefined" == t : Object.prototype.toString.call(e).toLowerCase() == "[object " + t + "]"
            } catch (n) {
                return !1
            }
        },
        I = function(e, t, n) {
            ...
            for (var o in e)
                if (e.hasOwnProperty(o)) {
                    var r = e[o];
                    r && (T(r, "function") || (T(r, "date") ? r = r.getTime() : T(r, "array") ? r = r.join(",") : T(r, "object") && (r = JSON.stringify(r)), n && (r = encodeURIComponent(r)), i.push(encodeURIComponent(o) + "=" + r)))
                }
            return i.join(t || ",")
        },
        x = function() {
            var e = "MSG|",
                t = function(t) {
                    var n = {};
                    return t = t || {}, n.origin = t.origin || "", n.ref = location.href, n.self = t.source, n.data = JSON.stringify(t.data), e + I(n, "|", !0)
                };
            return function(e, n) {
                window.postMessage ? (n = n || {}, e.postMessage(JSON.stringify(n.data), w(n.origin))) : l.unshift({
                    w: e,
                    d: escape(t(n))
                })
            }
        ...
        k = function() {
            ...
            if ("Netscape" == e) {
                ...
                t.opener = null, t.close()
            } else "Microsoft Internet Explorer" == e && (window.opener = null, window.open("", "_self"), window.close())
        };
    return window.URS = function() {
        var o = function() {
                var e = (new Date).getTime() + Math.random();
                return i[e] ? o() : (i[e] = e, e)
            },
            r = function(e) {
                this._options = e, e.needUrsBgp && "1" == e.needUrsBgp && (window._$needUrsBgp = 1), this.MGID = o(), n[this.MGID] = {}, this._$COM_NUM = 1 == this._$COM_NUM ? 1 : 2;
                var t = n[this.MGID];
                t.frameSize = e.frameSize, t.__coverBackground = e.coverBackground, t.__iframeShowAnimation = e.iframeShowAnimation, window.PTDOM = 0 != e.isHttps ? "https://" : "http://", e.cssDomain && e.cssFiles && (t.__cssStr = "cd=" + e.cssDomain + "&cf=" + e.cssFiles, t.__cssStr.indexOf("http://") != -1 && (window.PTDOM = "http://"), t.__cssStr = encodeURIComponent(t.__cssStr)), this.isInclude = 0, e.includeBox && ("string" == typeof e.includeBox ? this.isInclude = document.getElementById(e.includeBox) || 0 : this.isInclude = e.includeBox), t.needPrepare = e.needPrepare || 0, "string" == typeof e.eventType && (this._type = e.eventType), "string" == typeof e.bid ? this._btn = document.getElementById(e.bid) : this._btn = e.bid, e.logincb && (this.logincb = e.logincb), e.closecb && (this.closecb = e.closecb), e.regcb && (this.regcb = e.regcb), e.loginCheckLock && (this.loginCheckLock = e.loginCheckLock), e.regCheckLock && (this.regCheckLock = e.regCheckLock), e.initReady && (this.initReady = e.initReady), e.statecb && (this.statecb = e.statecb), e.resize && (this.resize = e.resize), e.changepage && (this.changepage = e.changepage), e.loginstate && (this.loginstate = e.loginstate), e.otherRegSuccess && (this.otherRegSuccess = e.otherRegSuccess);
                var i = document.createElement("div");
                i.id = "x-URS" + this.MGID, document.body.appendChild(i), this.box = i;
                var r = "index.html";
                e.single && (r = "index_dl.html", "register" == e.page && (r = "index_reg.html"));
                var s = e.crossDomainUrl || "webzj.reg.163.com/v1.0.1/pub/";
                this._url_cache = window.PTDOM + s + r, e.pathB && (this._url_cache = c(this._url_cache)), t.__cssStr ? this._url_cache += "?" + t.__cssStr + "&MGID=" + this.MGID + "&wdaId=" + (e.wdaId || "") : this._url_cache += "?MGID=" + this.MGID + "&wdaId=" + (e.wdaId || ""), this._urs_options = e || {};
                try {
            ...
            p = function(e) {
                ...
                if (a) {
                    ...
                    if (a.MGID)
                        if (i = t[a.MGID], o = n[a.MGID], r = i.isInclude ? i.includeBox : o._panel, a["URS-READY-DONE"] && (i.readyDone = 1, i.sto = clearTimeout(i.sto), i.initReady && i.initReady()), a["URS-READY"] && (i.ursReady = 1), !window.postMessage || !a["URS-READY"] || !i.isInclude && o.needPrepare)
                            if (a["URS-READY"] && !o._initReady && (o._initReady = !0), a["URS-CM-STATE"]) i.statecb && i.statecb(a["URS-CM-STATENAME"], a["URS-CM-STATE"]);
                    ...
                    } else "otherRegSuccess" == a.type ? i.otherRegSuccess && i.otherRegSuccess(a) : "success" == a.type ? (i.logincb && i.logincb(a.username, a.isOther, a), this.isInclude || (i._btn && i._type && s(i._btn, i._type, i.showIframe.bind(i)), i.closeIframe())) : "close" == a.type ? (i.closecb && i.closecb(), i.closeIframe()) : "resize" == a.type || "init" == a.type ? (r.style.width = a.width + "px", r.style.height = a.height + "px", i.isInclude || (r.style.marginLeft = -1 * a.width / 2 + "px"), i.resize && i.resize(a)) : "register-success" == a.type ? i.regcb && i.regcb(a.username, a.url) : "lockLoginState" == a.type ? i.loginCheckLock && i.loginCheckLock(a.value) : "lockRegState" == a.type ? i.regCheckLock && i.regCheckLock(a.value) : "changepage" == a.type ? i.changepage && i.changepage(a.page) : "loginstate" == a.type && i.loginstate && i.loginstate(a);
                    else b.call(i)
                }
            },
            h = function() {
                var e = "MSG|",
                    t = function(e, t) {
                        for (var n, i = T(t, "function") ? t : function(e) {
                                return e === t
                            }, o = null, r = 0, a = e.length - 1; r < a; r++) n = e[r], i(n) && (o = r);
                        return null != o ? o : -1
                    },
                    n = function() {
                        var e, n = function(n, i, o) {
                            t(e, n.w) < 0 && (e.push(n.w), o.splice(i, 1), n.w.name = n.d)
                        };
                        return function() {
                            if (e = [], l && l.length)
                                for (var t, i = l.length; i--; i >= 0) t = l[i], n(t, i, l);
                            e = null
                        }
                    }(),
                    i = function() {
                ...
                return function() {
                    setInterval(n, 100), setInterval(i, 20)
                }
            }(),
            f = function() {
                window.__hasRun || (window.postMessage ? a(window, "message", d) : h(), window.__hasRun = 1)
            };
        return function(i) {
            r.call(this, i);
            var o = n[this.MGID];
            return (o.needPrepare || this.isInclude) && this.prepareIframe(), e[this.MGID] = p.bind(this), t[this.MGID] = this, f()
        }
    }(), window.URS.prototype.prepareIframe = function() {
        this.isInclude ? (g.call(this, this.includeBox, 1, {
            id: this.MGID
        }), m.call(this), this.showIframe()) : (g.call(this, this.box, 0, {
            id: this.MGID
        }), m.call(this))
        ...
        if (!this.isInclude)
            if (t.needPrepare) {
                if (!t._initReady) return
            } else g.call(this, this.box, 0, {
                id: this.MGID
            }), m.call(this);
        if (e = e || {}, e.page) {
            if (e.page != this._urs_options.page && this._urs_options.single) {
                var i = "index_dl.html";
                "register" == e.page && (i = "index_reg.html"), this._url_cache = window.PTDOM + "webzj.reg.163.com/v1.0.1/pub/" + i, e.pathB && (this._url_cache = c(this._url_cache)), t.__cssStr ? this._url_cache += "?" + t.__cssStr + "&MGID=" + this.MGID : this._url_cache += "?MGID=" + this.MGID
            }
            m.call(this), this._urs_options.page = e.page
        }
        t.needPrepare && !this.isInclude && b.call(this), this.box.style.display = "block", this._options.afterShow && this._options.afterShow.call(this)
    }, window.URS.prototype.closeIframe = function() {
        var e = n[this.MGID];
        if (!this.isInclude && (this.box.style.display = "none", m.call(this), !e.needPrepare)) {
            if (navigator.userAgent.indexOf("MSIE") > 0) {
                ...
                if (t) {
                    t.src = "about:blank";
                    try {
                        i.document.write(""), i.document.clear()
                    } catch (o) {}
                }
                var r = document.getElementById("x-panel" + this.MGID);
                r.removeChild(t), window.CollectGarbage()
            }
            this.box.innerHTML = ""
        }
    ...
    function e(t, i) {
        function r(e) {
            ...
            if ("bug-string-char-index" == e) t = "a" != "a" [0];
                ...
                if ("json-parse" == e) {
                    if (t = i.parse, "function" == typeof t) try {
                        if (0 === t("0") && !t(!1)) {
        ...
        if (!r("json")) {
            ...
            if ((f = c.hasOwnProperty) || (f = function(e) {
                    ...
                    for (r in o) f.call(o, r) && a++;
                    return i = o = null, a ? g = 2 == a ? function(e, t) {
                        var n, i = {},
                            o = "[object Function]" == v.call(e);
                        for (n in e) o && "prototype" == n || f.call(i, n) || !(i[n] = 1) || !f.call(e, n) || t(n)
                    } : function(e, t) {
                        var n, i, o = "[object Function]" == v.call(e);
                        for (n in e) o && "prototype" == n || !f.call(e, n) || (i = "constructor" === n) || t(n);
                        (i || f.call(e, n = "constructor")) && t(n)
                    } : (o = "valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "), g = function(e, t) {
                        var i, r = "[object Function]" == v.call(e),
                            a = !r && "function" != typeof e.constructor && n[typeof e.hasOwnProperty] && e.hasOwnProperty || f;
                        for (i in e) r && "prototype" == i || !a.call(e, i) || t(i);
                ...
                var k = {
                    ...
                    C = function(e, t, n, i, o, r, a) {
                        ...
                        if ("object" == typeof s && s)
                            if (c = v.call(s), "[object Date]" != c || f.call(s, "toJSON")) "function" == typeof s.toJSON && ("[object Number]" != c && "[object String]" != c && "[object Array]" != c || f.call(s, "toJSON")) && (s = s.toJSON(e));
                            else if (s > -1 / 0 && s < 1 / 0) {
                            if (x) {
                                for (u = T(s / 864e5), c = T(u / 365.2425) + 1970 - 1; x(c + 1, 0) <= u; c++);
                                for (l = T((u - x(c, 0)) / 30.42); x(c, l + 1) <= u; l++);
                                u = 1 + u - x(c, l), p = (s % 864e5 + 864e5) % 864e5, h = T(p / 36e5) % 24, y = T(p / 6e4) % 60, b = T(p / 1e3) % 60, p %= 1e3
                            } else c = s.getUTCFullYear(), l = s.getUTCMonth(), u = s.getUTCDate(), h = s.getUTCHours(), y = s.getUTCMinutes(), b = s.getUTCSeconds(), p = s.getUTCMilliseconds();
                            s = (0 >= c || 1e4 <= c ? (0 > c ? "-" : "+") + _(6, 0 > c ? -c : c) : _(4, c)) + "-" + _(2, l + 1) + "-" + _(2, u) + "T" + _(2, h) + ":" + _(2, y) + ":" + _(2, b) + "." + _(3, p) + "Z"
                        } else s = null;
                        if (n && (s = n.call(t, e, s)), null === s) return "null";
                        if (c = v.call(s), "[object Boolean]" == c) return "" + s;
                        if ("[object Number]" == c) return s > -1 / 0 && s < 1 / 0 ? "" + s : "null";
                        if ("[object String]" == c) return S("" + s);
                        if ("object" == typeof s) {
                            for (e = a.length; e--;)
                                if (a[e] === s) throw d();
                            if (a.push(s), w = [], t = r, r += o, "[object Array]" == c) {
                                for (l = 0, e = s.length; l < e; l++) c = C(l, s, n, i, o, r, a), w.push(c === m ? "null" : c);
                                e = w.length ? o ? "[\n" + r + w.join(",\n" + r) + "\n" + t + "]" : "[" + w.join(",") + "]" : "[]"
                ...
                i.stringify = function(e, t, i) {
                    ...
                    if (n[typeof t] && t)
                        ...
                        a = {};
                        for (var c, l = 0, u = t.length; l < u; c = t[l++], s = v.call(c), ("[object String]" == s || "[object Number]" == s) && (a[c] = 1));
                    }
                    if (i)
                        if ("[object Number]" == (s = v.call(i))) {
                            if (0 < (i -= i % 1))
                                for (o = "", 10 < i && (i = 10); o.length < i; o += " ");
                        } else "[object String]" == s && (o = 10 >= i.length ? i : i.slice(0, 10));
                    return C("", (c = {}, c[""] = e, c), r, a, o, "", [])
                }
            }
            if (!r("json-parse")) {
                var N, D, M = s.fromCharCode,
                    j = {
                        92: "\\",
                        34: '"',
                        47: "/",
                    ...
                    L = function() {
                        for (var e, t, n, i, o, r = D, a = r.length; N < a;) switch (o = r.charCodeAt(N)) {
                            case 9:
                            case 10:
                            case 13:
                            case 32:
                            ...
                            case 58:
                            case 44:
                                return e = w ? r.charAt(N) : r[N], N++, e;
                            case 34:
                                for (e = "@", N++; N < a;)
                                    if (o = r.charCodeAt(N), 32 > o) O();
                                    else if (92 == o) switch (o = r.charCodeAt(++N)) {
                                    case 92:
                                    case 34:
                                    case 47:
                                    case 98:
                                    ...
                                    case 114:
                                        ...
                                        break;
                                    case 117:
                                        for (t = ++N, n = N + 4; N < n; N++) o = r.charCodeAt(N), 48 <= o && 57 >= o || 97 <= o && 102 >= o || 65 <= o && 70 >= o || O();
                                        e += M("0x" + r.slice(t, N));
                                        break;
                                    default:
                                        O()
                                    ...
                                    if (34 == o) break;
                                    for (o = r.charCodeAt(N), t = N; 32 <= o && 92 != o && 34 != o;) o = r.charCodeAt(++N);
                                    e += r.slice(t, N)
                                }
                                if (34 == r.charCodeAt(N)) return N++, e;
                                O();
                            default:
                                if (t = N, 45 == o && (i = !0, o = r.charCodeAt(++N)), 48 <= o && 57 >= o) {
                                    for (48 == o && (o = r.charCodeAt(N + 1), 48 <= o && 57 >= o) && O(); N < a && (o = r.charCodeAt(N), 48 <= o && 57 >= o); N++);
                                    if (46 == r.charCodeAt(N)) {
                                        for (n = ++N; n < a && (o = r.charCodeAt(n), 48 <= o && 57 >= o); n++);
                                        n == N && O(), N = n
                                    }
                                    if (o = r.charCodeAt(N), 101 == o || 69 == o) {
                                        for (o = r.charCodeAt(++N), 43 != o && 45 != o || N++, n = N; n < a && (o = r.charCodeAt(n), 48 <= o && 57 >= o); n++);
                                        n == N && O(), N = n
                                    }
                                    return +r.slice(t, N)
                                }
                                if (i && O(), "true" == r.slice(N, N + 4)) return N += 4, !0;
                    ...
                    A = function(e) {
                        ...
                        if ("$" == e && O(), "string" == typeof e) {
                            ...
                            if ("[" == e) {
                                for (t = []; e = L(), "]" != e; n || (n = !0)) n && ("," == e ? (e = L(), "]" == e && O()) : O()), "," == e && O(), t.push(A(e));
                                return t
                            }
                            if ("{" == e) {
                                for (t = {}; e = L(), "}" != e; n || (n = !0)) n && ("," == e ? (e = L(), "}" == e && O()) : O()), "," != e && "string" == typeof e && "@" == (w ? e.charAt(0) : e[0]) && ":" == L() || O(), t[e.slice(1)] = A(L());
                                return t
                            }
                            O()
                        }
                    ...
                    z = function(e, t, n) {
                        n = E(e, t, n), n === m ? delete e[t] : e[t] = n
                    },
                    E = function(e, t, n) {
                        var i, o = e[t];
                        if ("object" == typeof o && o)
                            if ("[object Array]" == v.call(o))
                                for (i = o.length; i--;) z(o, i, n);
                            else g(o, function(e) {
                                z(o, e, n)
                            });
                        return n.call(e, t, o)
                ...
                i.parse = function(e, t) {
                    var n, i;
                    return N = 0, D = "" + e, n = A(L()), "$" != L() && O(), N = D = null, t && "[object Function]" == v.call(t) ? E((i = {}, i[""] = n, i), "", t) : n
                }
            }
        }
...
! function(e) {
    function t(e, t) {
        var i, o, r, a, s, c, l, u, d, p, h, f, g = [],
            m = e.split(S),
            y = [t];
        for (r = 0, a = m.length; r < a; r++) {
            for (i = m[r], o = i.replace(j, ""), s = 0, c = y.length; s < c; s++) t = y[s], D.test(i) ? (h = D.exec(o), l = h[1], f = document.getElementById(l), f && v.contains(t, f) && g.push(f)) : M.test(i) && (h = M.exec(o), u = h[1], g = g.concat(n(u, t))), j.test(i) && (h = j.exec(i), d = h[1], p = h[2], g = v.map(g, function(e) {
                return e[d] === p ? e : null
            }));
            r !== a - 1 && (y = g, g = [])
        }
    ...
    function n(e, t, n) {
        for (var i = [], o = t.getElementsByTagName(n || "*"), r = o.length, a = new RegExp("(^|\\s)" + e + "(\\s|$)"), s = 0, c = 0; s < r; s++) a.test(o[s].className) && (i[c] = o[s], c++);
        return i
    }
    ...
    function u(e, t, n, i) {
        A[t] ? A[t](e, n) : document.addEventListener ? e.addEventListener(t, n, i) : (t = L[t] ? L[t].delegateType : t, e.attachEvent("on" + t, function() {
            n.call(e, arguments[0])
        }))
    }

    function d(e) {
        return e = e || window.event, e.target || (e.target = e.srcElement), e.preventDefault || (e.preventDefault = function() {
            e.returnValue = !1
        }), e
    }
    ...
    function h(e, t, n) {
        var i = new XMLHttpRequest,
            ...
            r = e.type,
            a = e.url;
        if (o && "object" == typeof o && (o = v.serialize(o)), "GET" === r && o && (a += (E.test(a) ? "&" : "?") + o, o = null), a += (E.test(a) ? "&" : "?") + "_=" + z++, i.open(r, a, e.async), i.timeout = e.timeout, "POST" === r && i.setRequestHeader("Content-type", e.contentType), n)
            for (var s in n) i.setRequestHeader(s, n[s]);
        return void 0 === e.withCredentials ? i.withCredentials = !0 : i.withCredentials = e.withCredentials, i.send(o), i.onreadystatechange = function() {
    ...
    function f(e, t) {
        function n() {
            i = void 0, a.onload = a.onreadystatechange = null, U.removeChild(a), a = void 0
        }
        var i, o = e.data,
            r = e.url,
            a = document.createElement("script");
        e.jsonpCallback = e.jsonpCallback || v.expando + "_" + z++, o && (o = "object" == typeof o ? v.serialize(o) : o, r += (E.test(r) ? "&" : "?") + o, o = null), r += (E.test(r) ? "&" : "?") + e.jsonp + "=" + e.jsonpCallback, r += (E.test(r) ? "&" : "?") + "_=" + z++, a.src = r, a.setAttribute("async", !0), a.charset = e.scriptCharset, U.appendChild(a), window[e.jsonpCallback] = function() {
            i = arguments
        }, a.onload = a.onreadystatechange = function() {
            this.readyState && "loaded" != this.readyState && "complete" != this.readyState || (t && t(i && i[0]), n())
        }, a.onerror = function() {
            t(null), n()
        }
    }
    ...
    function g(e, t) {
        function n(e) {
            var n, i, o;
            try {
                n = a.contentDocument, i = n.location, o = n.body.innerHTML
            } catch (r) {}
            t && t(o, i, n)
        }
        var i, o, r, a, s = "",
        ...
        e.removeIframe && (i.remove(), o.remove())
    }
    ...
    v.fn = v.prototype = {
        ...
        find: function(e) {
            var t, n, i = this.length,
                o = [];
            for (t = 0; t < i; t++) n = v(e, this[t]), v.each(n, function(e, t) {
                o.push(t)
            });
        ...
        html: function(e) {
            ...
            for (; n < i; n++) t = this[n], 1 === t.nodeType && (t.innerHTML = e);
            return this
        },
        val: function(e) {
            var t = this[0] || {},
                n = 0,
                i = this.length;
            if (void 0 === e && 1 === t.nodeType) return t.value;
            for (; n < i; n++) t = this[n], 1 === t.nodeType && (t.value = e);
            return this
        },
        attr: function(e, t) {
            var n = this[0] || {},
                i = 0,
                o = this.length;
            if (void 0 === t && 1 === n.nodeType) return _.test(e) ? n[e] : n.getAttribute(e);
            if ("string" == typeof t) {
                for (; i < o; i++) n = this[i], 1 === n.nodeType && (_.test(e) ? n[e] = t : n.setAttribute(e, t));
                return this
            }
        },
        addCls: function(e) {
            var t, n, i = 0,
                o = this.length;
            if (e)
                for (; i < o; i++) t = this[i], 1 === t.nodeType && (t.classList ? t.classList.add(e) : (n = " " + t.className + " ", n.indexOf(" " + e + " ") < 0 && (n += e + " ", t.className = v.trim(n))));
            return this
        },
        delCls: function(e) {
            var t, n, i = 0,
                o = this.length;
            if (e)
                for (; i < o; i++) t = this[i], 1 === t.nodeType && (t.classList ? t.classList.remove(e) : (n = (" " + t.className + " ").replace(C, " "), n.indexOf(" " + e + " ") >= 0 && (n = n.replace(" " + e + " ", " ")), t.className = v.trim(n)));
            return this
        },
        tglCls: function(e) {
            var t, n, i = 0,
                o = this.length;
            if (e)
                for (; i < o; i++) t = this[i], 1 === t.nodeType && (t.classList ? t.classList.toggle(e) : (n = this.eq(i), n.hasCls(e) ? n.delCls(e) : n.addCls(e)));
            return this
        },
        hasCls: function(e) {
            var t, n = 0,
            ...
            if (e)
                for (; n < i; n++)
                    if (t = this[n], 1 === t.nodeType)
                        if (t.classList) {
                            if (t.classList.contains(e)) return !0
                        } else if ((" " + t.className + " ").replace(C, " ").indexOf(e) >= 0) return !0;
            return !1
        },
        show: function() {
            for (var e, t, n, i = 0, a = this.length; i < a; i++) e = this[i], t = e.getAttribute("data-display"), t && "none" !== t ? n = t : "none" !== (n = o(e, "display")) || (n = r(e)), e.style.display = n;
            return this
        },
        hide: function() {
            for (var e, t = 0, n = this.length; t < n; t++) e = this[t], e.setAttribute("data-display", o(e, "display")), e.style.display = "none";
            return this
        },
        position: function() {
            var e = this[0],
            ...
            if (arguments.length > 1 || "object" == typeof i) {
                for (; null != (e = this[n]); n++)
                    if (1 === e.nodeType || 11 === e.nodeType || 9 === e.nodeType)
                        for (t in i) e.style[t] = i[t];
                return this
            }
            return e = this[0], o(e, i)
        },
        width: function(e) {
            var t, n, i, o = 0;
            if (e && "number" == typeof e) {
                for (; null != (t = this[o]); o++) 1 === t.nodeType && (t.style.width = e + "px");
                return this
            }
            return t = this[0], v.isWindow(t) ? n = t.document.documentElement.clientWidth : 9 === t.nodeType ? (i = t.documentElement, n = Math.max(t.body.scrollWidth, i.scrollWidth, t.body.offsetWidth, i.offsetWidth, i.clientWidth)) : n = t.offsetWidth, n
        },
        height: function(e) {
            var t, n, i, o = 0;
            if (e && "number" == typeof e) {
                for (; null != (t = this[o]); o++) 1 === t.nodeType && (t.style.height = e + "px");
                return this
            }
            return t = this[0], v.isWindow(t) ? n = window.innerHeight || t.document.documentElement.clientHeight : 9 === t.nodeType ? (i = t.documentElement, n = Math.max(t.body.scrollHeight, i.scrollHeight, t.body.offsetHeight, i.offsetHeight, i.clientHeight)) : n = t.offsetHeight, n
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (e.textContent = "");
            return this
        },
        remove: function() {
            for (var e, t = 0; null != (e = this[t]); t++) e.parentNode && e.parentNode.removeChild(e);
            return this
        },
        append: function() {
            for (var e, t = 0, n = v.parseDom(arguments[0]); null != (e = this[t]); t++) 1 !== e.nodeType && 11 !== e.nodeType && 9 !== e.nodeType || e.appendChild(n.cloneNode(!0));
            return this
        },
        prepend: function() {
            for (var e, t = 0, n = v.parseDom(arguments[0]); null != (e = this[t]); t++) 1 !== e.nodeType && 11 !== e.nodeType && 9 !== e.nodeType || e.insertBefore(n.cloneNode(!0), e.firstChild);
            return this
        },
        before: function() {
            for (var e, t = 0, n = v.parseDom(arguments[0]); null != (e = this[t]); t++) e.parentNode && e.parentNode.insertBefore(n.cloneNode(!0), e);
            return this
        },
        after: function() {
            for (var e, t = 0, n = v.parseDom(arguments[0]); null != (e = this[t]); t++) e.parentNode && e.parentNode.insertBefore(n.cloneNode(!0), e.nextSibling);
            return this
        }
    };
    var N = v.fn.init = function(e, n) {
        ...
        if (!e) return this;
        if ("string" == typeof e) {
            e = v.trim(e), i = document.querySelectorAll ? n.querySelectorAll(e) : t(e, n);
            for (var o = 0; o < i.length; o++) this[o] = i[o];
            this.length = i.length
        } else(e.nodeType || e.window) && (this[0] = e, this.length = 1);
    ...
    v.extend = v.fn.extend = function() {
        ...
        contains: function(e, t) {
            return e !== document || document.contains || (e = document.documentElement || document.body), e.contains(t)
        },
        trim: function(e) {
            return null == e ? "" : (e + "").replace(k, "")
        },
        parseDom: function(e) {
            var t, n, i, o = document.createDocumentFragment(),
                r = 0,
                a = [];
            if ("string" == typeof e) {
                for (t = document.createElement("div"), t.innerHTML = e, i = t.childNodes, n = i.length; r < n; ++r) a.push(i[r]);
                for (r = 0; r < n; r++) o.appendChild(a[r])
            } else if ("object" == typeof e && e.nodeType) o.appendChild(e);
            else if (e instanceof v)
                for (r = 0; r < e.length; r++) o.appendChild(e[r]);
            else v.log("\u4f20\u9012\u7684\u53c2\u6570\u975e\u6cd5!");
            return o
        },
        each: function(e, t) {
            var n, i = 0,
                ...
                r = a(e);
            if (r)
                for (; i < o && (n = t.call(e[i], i, e[i]), n !== !1); i++);
            else
                for (i in e)
                    if (n = t.call(e[i], i, e[i]), n === !1) break
        },
        map: function(e, t) {
            var n, i = 0,
                o = e.length,
                ...
                s = [];
            if (r)
                for (; i < o; i++) n = t(e[i], i), null != n && s.push(n);
            else
        ...
        proxy: function(e, t) {
            var n, i;
            return n = T.call(arguments, 2), i = function() {
        ...
        unique: function(e) {
            if (document.documentElement.compareDocumentPosition) {
                ...
                e.sort(t);
                for (var n = 1; n < e.length; n++) e[n] === e[n - 1] && e.splice(n--, 1)
            }
            return e
        },
        dir: function(e, t, n) {
        ...
        v.fn[e] = function() {
            var e = v.map(this, t);
            return this.length > 1 && v.unique(e), this.pushStack(e)
        }
    }), v.fn.extend({
        parentToLevel: function(e) {
            var t = e || 1,
                ...
                i = v.map(this, function(e) {
                    for (var i = e;
                        (i = i.parentNode) && 11 !== i.nodeType && ++n < t;);
                    return i
                });
            return this.length > 1 && v.unique(i), this.pushStack(i)
        },
        child: function(e) {
    ...
    var L = {
        ...
        A = {
            tap: function(e, t) {
                ...
                u(e, n, function(e) {
                    var t = v(e.target);
                    t.attr("data-start-X", e.changedTouches[0].screenX + ""), t.attr("data-start-Y", e.changedTouches[0].screenY + "")
                }, !l(n)), u(e, i, function(e) {
                    var n = v(e.target),
                    ...
                    n.attr("data-end-X", o + ""), n.attr("data-end-Y", a + ""), Math.abs(o - r) <= i && Math.abs(a - s) <= i && t(e)
                }, !l(i))
            }
        };
    v.event = {
        add: function(e, t, n, i) {
            ...
            i = a(i) ? i : [i], o.push({
                ...
                target: i,
                handler: n
            }), e.events = o, e.events[t] || (u(e, t, function(n) {
                var i, n = d(n);
                v.each(e.events, function(o, r) {
                    var a, s;
                    r.type === t && (i = r.target, v.each(i, function(t, i) {
                        "string" == typeof i && (a = v(i, e), s = c(a, n.target), s && r.handler.call(s, n)), "object" == typeof i && v.contains(i, n.target) && r.handler.call(i, n)
                    }))
                })
            }, !l(t)), e.events[t] = !0)
        },
        ...
        on: function(e, t, n) {
            for (var i, o = arguments, r = e.split(/\s+/), a = 0; a < r.length; a++) e = r[a], v.each(this, function(r, a) {
                2 === o.length ? (i = o[1], v.event.add(a, e, i)) : (i = n, v.event.add(a, e, i, [t]))
            });
            return this
        },
        off: function(e, t, n) {
            ...
            return v.each(this, function(r, a) {
                var s;
                0 === o.length ? v.event.del(a) : 1 === o.length ? v.event.del(a, e) : 2 === o.length ? (i = o[1], v.event.del(a, e, i)) : (i = n, s = v(t, a), s = 0 === s.length ? [t] : s, v.event.del(a, e, i, v(t)))
            }), this
        },
        trigger: function(e) {
    ...
    try {
        B = R.exec(P), 0 === B.length && (B = P.match(R))
    } catch (H) {
    ...
    v.extend({
        serialize: function(e) {
            ...
            for (var n in e) {
                var i = e[n];
                if (null !== i && void 0 !== i || (i = ""), i.constructor == Array)
                    for (var o = 0, r = i.length; o < r; o++) t.push(n + "=" + encodeURIComponent(i[o]));
                else t.push(n + "=" + encodeURIComponent(i))
            }
            return t.join("&")
        },
        getData: function(e, t, n) {
            var e = v.extend({}, G, e);
            e.type = e.type.toUpperCase(), null === e.crossDomain && (e.crossDomain = m(e.url)), e.crossDomain ? ("GET" === e.type && f(e, t), "POST" === e.type && (e.supportCORS ? h(e, t, n) : g(e, t))) : h(e, t, n)
        },
        getFormData: function(e) {
            var t, n, i, o, r = e.find("input, textarea"),
                a = {},
                s = [];
            if (0 === r.length) {
                for (i = e[0].getElementsByTagName("input"), o = e[0].getElementsByTagName("textarea"), t = 0, n = i.length; t < n; t++) s.push(i[t]);
                for (t = 0, n = o.length; t < n; t++) s.push(o[t]);
                r = s
            }
            return v.each(r, function(e, t) {
                t = v(t), ("checkbox" !== t.attr("type") || "checkbox" === t.attr("type") && t.attr("checked")) && (a[t.attr("name")] = t.val())
            }), a
        },
        ...
        loadCSS: function(e) {
            ...
            t.rel = "stylesheet", t.type = "text/css", t.href = e, U.appendChild(t)
        }*/
    }), Tie.tool = v
}(),
function(e) {
    function t(t, n) {
        e.isNative(window.scrollTo) ? window.scrollTo(t, n) : document.documentElement && document.documentElement.scrollTop ? (document.documentElement.scrollLeft = t, document.documentElement.scrollTop = n) : document.body && (document.body.scrollLeft = t, document.body.scrollTop = n)
    }
    ...
    e.extend({
        ...
        render: function(e, t) {
            ...
            for (var n, i = /<%((?:(?!%>).)+)?%>/g, o = /(^( )?(if|for|else|switch|case|break|{|}))(.*)?/g, r = "var r=[];\n", a = 0, s = function(e, t) {
                ...
                }; n = i.exec(e);) s(e.slice(a, n.index))(n[1], !0), a = n.index + n[0].length;
            s(e.substr(a, e.length - a)), r += 'return r.join("");', t = isNaN(t.length) ? [t] : t;
            for (var c = "", l = 0, u = t.length; l < u; l++) c += new Function(r.replace(/[\r\t\n]/g, "")).apply(t[l]);
            return c
        },
        dataReplace: function(e, t) {
            e = e || "", t = t || [""];
            for (var n, i = /{{((?:(?!}}).)+)?}}/g, o = "return ", r = 0, a = function(e, t) {
                    return o += t ? "+this." + e + "+" : '"' + e + '"', a
                }; n = i.exec(e);) a(e.slice(r, n.index))(n[1], !0), r = n.index + n[0].length;
            return a(e.substr(r, e.length - r)), new Function(o).apply(t)
        },
        cookie: {
            ...
            get: function(e, t) {
                var n = this;
                e = n.encoder(e) + "=";
                var i, o = document.cookie,
                    r = o.indexOf(e);
                return -1 === r ? t ? void 0 : "" : (r += e.length, i = o.indexOf(";", r), i === -1 && (i = o.length), n.decoder(o.substring(r, i)))
            },
            set: function(e, t, n, i, o, r) {
                ...
                if (n) {
                    var c, l;
                    n instanceof Date ? c = n : ("string" == typeof n && this.EXPIRESWITHUNIT.test(n) && (n = n.substring(0, n.length - 1), l = RegExp.lastMatch), isNaN(n) || (c = new Date, c.setTime(c.getTime() + n * this.TIMEUNITS[l || "m"] * 1e3))), c && s.push("expires=" + c.toUTCString())
                }
                o && s.push("path=" + o), i && s.push("domain=" + i), r && s.push("secure"), document.cookie = s.join(";")
            },
            del: function(e, t, n) {
        ...
        subChineseStr: function(e, t, n) {
            ...
            for (var i = "", o = 0, r = 0; r < e.length; r++) {
                if (e.charCodeAt(r) > 255 ? o += 2 : o++, o >= t) return n ? i + "..." : i;
                i += e.charAt(r)
            }
            return e
        },
        ...
        scrollTo: function(e, n, i) {
            var o, r, a, s, c, l = 50;
            i ? (o = Math.max(document.documentElement.scrollLeft, document.body.scrollLeft), r = Math.max(document.documentElement.scrollTop, document.body.scrollTop), s = (e - o) / (i / l), c = (n - r) / (i / l), a = setInterval(function() {
                o += s, r += c, s > 0 && o > e || c > 0 && r > n || s < 0 && o < e || c < 0 && r < n ? clearInterval(a) : t(o, r)
        ...
        base64Encode: function(e) {
            var t, i, o, r, a, s;
            for (o = e.length, i = 0, t = ""; i < o;) {
                if (r = 255 & e.charCodeAt(i++), i == o) {
                    t += n.charAt(r >> 2), t += n.charAt((3 & r) << 4), t += "==";
                    break
                }
                if (a = e.charCodeAt(i++), i == o) {
                    t += n.charAt(r >> 2), t += n.charAt((3 & r) << 4 | (240 & a) >> 4), t += n.charAt((15 & a) << 2), t += "=";
                    break
                }
                s = e.charCodeAt(i++), t += n.charAt(r >> 2), t += n.charAt((3 & r) << 4 | (240 & a) >> 4), t += n.charAt((15 & a) << 2 | (192 & s) >> 6), t += n.charAt(63 & s)
            }
            return t
        },
        base64Decode: function(e) {
            var t, n, o, r, a, s, c;
            for (s = e.length, a = 0, c = ""; a < s;) {
                do t = i[255 & e.charCodeAt(a++)]; while (a < s && t == -1);
                if (t == -1) break;
                do n = i[255 & e.charCodeAt(a++)]; while (a < s && n == -1);
                if (n == -1) break;
                c += String.fromCharCode(t << 2 | (48 & n) >> 4);
                do {
                    if (o = 255 & e.charCodeAt(a++), 61 == o) return c;
                    o = i[o]
                } while (a < s && o == -1);
                if (o == -1) break;
                c += String.fromCharCode((15 & n) << 4 | (60 & o) >> 2);
                do {
                    if (r = 255 & e.charCodeAt(a++), 61 == r) return c;
                    r = i[r]
                } while (a < s && r == -1);
                if (r == -1) break;
        ...
        refresh: function(t, n) {
            ...
            n.find("[ne-id='" + t + "']").each(function(t) {
                var n, i = e(this),
                    o = i.attr("ne-tmpl"),
                    r = i.attr("ne-data");
                r && (n = Tie.getByUID(r)), o && (/^\>/.test(o) ? i.html(e.render(Tie.tpl[o.substring(1)], n)) : (i.after(e.render(Tie.tpl[o], n)), i.remove()))
            })
        }
    })
}(Tie.tool),
function(e) {
    ...
    t.prototype = {
        parse: function(e, t, i) {
            this.maxP = 0, this.maxH = 0, "function" == typeof e && (i = t, t = e, e = null), e = e || document.body;
            ...
            /\u52a0\u8f7d\u4e2d|loading|^\s+$/i.test(s) && (s = ""), this.state = {
                title: s || document.title
            }, this.detectByHost(e) || this.detectByP(e), "function" == typeof t && (i || (this.state.content = this.state.content.replace(/<img .*?>/gi, "")), t(this.state))
        },
        detectByHost: function(e) {
            ...
            return s && (t = s()) && (this.state.content = t), t
        },
        detectByP: function(e) {
            ...
            n("p,div>br", e).each(function(e, c) {
                if (!r.test(c.className) && ("p" != a(c) || c.innerHTML.replace(/\s|&nbsp;/gi, ""))) {
                    var l = c.parentNode;
                    i.query = "", /^(i|font|b|em|strong|center)$/i.test(l.tagName) && (i.query = RegExp.$1, l = l.parentNode), o.indexOf(l) == -1 && (!i.detect(l) && n(c).position().top < .8 * s && (t += c.outerHTML), o.push(l))
                }
        ...
        getContent: function(e) {
            ...
            if (n("li a", e).length < 3)
                if (n(i, e)[0]) {
                    var o = e.cloneNode(!0);
                    n(i, o).remove(), t = o.innerHTML
                } else t = e.innerHTML;
            else n("p", e).each(function(e, n) {
                t += n.outerHTML
            });
            return t
        },
        detect: function(e) {
            var t = e.className || "",
                a = e.id || "";
            if (e == document.body || r.test(t) || r.test(a)) return !1;
            ...
            if ((e.offsetWidth > s / 2 || /allContent/i.test(a)) && n(e).position().top < .6 * document.body.offsetHeight && (o.test(t) || o.test(a) || c.replace(/<(?!img).*?>/g, "").replace(/\s/g, "").length > 60)) {
                var l = n(this.query + " p", e).length,
                    u = e.offsetHeight;
                if (l > this.maxP || u > this.maxH) return this.maxP = l, this.maxH = u, this.state.contentNode = e, this.state.content = c, !0
            }
            return !1
        }
    };
    var s = new t;
    e.third = e.third || {}, e.third.extractor = s
}(window.Tie),
function(e) {
    var t = e.tool;
    e.controller = {
        create: function(e) {
            ...
            return n.fn = n.prototype, n.fn.init = function() {}, n.fn.eventSplitter = /^(\w+)\s*(.*)$/, n.fn.delegateEvents = function(e) {
                function n(e) {
                    var n = [];
                    return e && t.each(e.split(/,/), function(e, t) {
                        a.test(t) && (t = new Function("return " + t.replace(a, "this.") + ";").call(o)), n.push(t)
                    }), n
                }

                function i(e) {
                    var n = t(this).attr("ne-model");
                    o.temp = t.trim(t(this).val()), new Function("this." + n + "= this.temp;").call(o)
                }
                var o = this,
                    r = {
                        stat: "click"
                ...
                t.each(e, function(e, i) {
                    var a, s, c = "ne-" + i;
                    i = r[i] || i, o.el.on(i, "[" + c + "]", function(e) {
                        for (var i = t(this).attr(c).split(/\s+/), r = 0; r < i.length; r++) a = i[r].match(/(\S+)\((\S+)?\)/), s = [e, o].concat(n(a[2])), o[a[1]].apply(this, s)
                    })
...
function(e) {
    ...
    o.tie.fn = n.extend(o.tie.prototype, {
        ...
        var o, t = t,
            ...
            c = "",
            l = !1;
        return 1 === i.code && (o = i.data, t = o.user, r = o.anonymous, a = o.siteName, s = o.ip, c = o.content, l = o.isDel), {
            newly: !0,
            anonymous: r,
            type: "trunk",
        ...
        var a, s, c, l, u, d, p = i.comments,
            h = [];
        t = e.config, a = r ? i.commentIdsAndDocId : i.commentIds;
        for (var f = 0; f < a.length; f++) {
            r ? (c = a[f].commentIds.split(","), c = n.map(c, function(e) {
                return a[f].docId + "_" + e
            })) : c = a[f].split(","), s = [];
            for (var g = c.length, m = 0, v = 0; v < g; v++) l = c[v], p[l] && !p[l].isDel && m++;
            for (var v = 0; v < g; v++) l = c[v], p[l] && !p[l].isDel && (r ? (d = i.threads[a[f].docId], u = new o.tie(l, p[l], r, d)) : u = new o.tie(l, p[l], r), u.order = v + 1, u.groupMemberSize = m, s.push(u));
            s && s.length > 0 && (s[s.length - 1].type = "trunk", h.push(n.clone(s)))
        }
        return h
        ...
        var s, c = "",
            l = i.length,
            u = e.tpl,
            d = u.floorTpl.upperTpl,
            p = u.floorTpl.lowerTpl,
            h = u.floorTpl.middleTpl,
            f = n.render;
        if (l >= 1 && "foldAll" === a || l >= t.startHideMdl && "off" === o) {
            var g, m, v = "";
            "startEnd" === a ? (v = f(d, i[0]) + f(p, i[0]), g = f(d) + v + f(h, n.extend(r, {
                hideMdlNum: l - 2,
                order: 2
            ...
            for (var y = 0; y < l; y++) s = i[y], c = f(d, s) + c + f(p, s);
        else
            for (var b = Math.round(t.nestedHierarchy / 2), y = 0; y < l; y++) s = i[y], c = s.order <= b || s.order > l - b ? f(d, s) + c + f(p, s) : c + f(d, s) + f(p, s);
        return c
        ...
        var a = e.tpl;
        if (t) {
            var s, c = o.tie.findTopsInGroup(t),
                l = (c.length, []);
            return n.each(c, function(e, t) {
                var o = n.clone(t);
                o._uid = i(), l.push(o)
            }), s = n.render(a.trunkTpl.upperTpl, r) + o.tie.buildQuoteNode(l, !1) + n.render(a.trunkTpl.lowerTpl, r), l.push(r), o.tie.cache().unshift(l), s
        }
        return n.render(a.trunkTpl.upperTpl, r) + n.render(a.trunkTpl.lowerTpl, r)
    }, o.tie.buildView = function(e, t) {
        for (var n = "", i = 0, r = e.length, t = t || "startEnd"; i < r; i++) n += o.tie.buildTrunkNode(e[i], "off", t);
        return n
    }, o.tie.findGroupById = function(e, t) {
        for (var n = null, i = 0; i < e.length; i++) {
            n = e[i];
            var o = n.length - 1;
            if (n[o].id === t) return n
        }
    }, o.tie.findTopsInGroup = function(e, t) {
        for (var n, t = t || o.tie.cache(), i = null, r = 0; r < t.length; r++) {
            i = t[r];
            for (var a = 0; a < i.length; a++)
                if (n = i[a], n.id === e) return i.slice(0, a + 1)
        }
    }, o.tie.findById = function(e, t) {
        for (var n, t = t || o.tie.cache() || o.tie.cacheI(), i = null, r = 0; r < t.length; r++) {
            i = t[r];
            for (var a = 0; a < i.length; a++)
                if (n = i[a], n.id === e) return n
        }
    }, o.tie._store = {}, o.tie.cache = function(t) {
        var i = o.tie._store,
            r = e.page;
        return t ? void(n.isArray(t) && (i[r.tab] = i[r.tab] || [], i[r.tab] = i[r.tab].concat(t))) : i[r.tab] && i[r.tab]
    }, o.tie.findByUID = function(e, t) {
        for (var n, t = t || o.tie.cache() || [], i = null, r = 0; r < t.length; r++) {
            i = t[r];
            for (var a = 0; a < i.length; a++)
                if (n = i[a], n._uid === parseInt(e)) return n
        }
    }, e.model = e.model || {}, n.extend(e.model, o)
}(window.Tie),
function(e) {
    function t() {
        c ? c = !0 : (r || (r = e.view.wrapper.child(-1), r = r && r[0].contentWindow), r || (r = e.view.wrapper.child(0), r = r && r[0].contentWindow), r = r || a("#yun-tie-data-ifrm-923")[0].contentWindow)
    }

    function n(e) {
        t(), r.postMessage(a.stringify(e), "*")
    }
    ...
    a(window).bind("message", function(e) {
        var i;
        t(), e.source === r && (i = e.data, "string" == typeof i && (i = a.parseJSON(i)), "getSSOUserInfo" === i.action && a.getData({
            url: i.url,
...
function(e) {
    e.convertPath = function(e) {
        var t;
        return "~" === e[0] ? (t = location.href.indexOf(/pc/), location.href.substring(0, t) + e.substring(1)) : e
    };
    var t = (e.tool, e.convertPath("https://api.gentie.163.com/pc/refresh.html")),
...
function(e) {
    ...
    e.tpl = {
        ...
        longStr: function(t, n) {
            return t = t || "", t ? e.tool.subChineseStr(t, n, !0) : ""
        },
        parallelFlr: function(t) {
            var n = t.groupSize - 1,
                ...
                r = "";
            return e.config.nestedHierarchy <= n && !(i <= o || i > n - o) && (r = e.set.stateCls.parallelFlr), r
        },
        calPageNum: function(t) {
            var n = [1],
                ...
                s = a - t,
                c = a + t;
            s < 2 && (c += Math.abs(s - 2), s = 2), c > r - 1 && (s -= Math.abs(c - (r - 1)), c = r - 1), s < 2 && (s = 2), c > r - 1 && (c = r - 1);
            for (var l = s; l <= c; l++) n.push(l);
...
function(e) {
    function t(e, t) {
        var n, i = t.essayURL || e.essayUrl,
            o = t.essayURL || e.essayUrl,
            r = t.content,
            a = {};
        return r = r.replace(/<[^>]+>/g, "").replace(/"/g, "\u201c"), n = r, r.length > 32 && (r = r.substr(0, 32) + "..."), n.length > 16 && (n = n.substr(0, 16) + "..."), a.url = encodeURIComponent(i), a.title = encodeURIComponent("\u300e" + n + "\u300f-- \u6765\u81ea\u6587\u7ae0\u300a" + (t.essayTitle || e.essayTitle) + "\u300b"), a.digest = encodeURIComponent(r), a.image = "", a.url3g = o, a
    }
    var n, i, o = e.tool,
        r = (e.set, [{
            id: "qq",
    ...
    e.share = {
        ...
        show: function(s, c, l) {
            ...
            var d = l.position(),
                p = t(s, c);
            n || (o(document.body).append(o.render(a, c)), n = o("#shareListWin"), i = o("#shareLoadingWin"), n.on("click", "a", function(t) {
                e.stat(o(this).attr("stat"))
            })), i.css({
                top: l.offset().top - n.height() - 60 + "px",
                display: "block"
            }), c.shareImage && (p.image = c.shareImage, o.each(n.children(), function(t, n) {
...
function(e) {
    ...
    function r(t, n) {
        var i, r = !1,
            a = e.tool,
            s = a.trim(t.content);
        return e.userInfo || C.anonymousSwitch ? (s.length <= 0 ? i = "\u8bf7\u8f93\u5165\u5185\u5bb9" : s.length < 2 ? i = "\u5185\u5bb9\u592a\u5c11\uff0c\u591a\u6253\u8d4f\u70b9\u6587\u5b57\u5427" : s.length > 1e3 ? i = "\u5185\u5bb9\u592a\u591a\uff0c\u8bf7\u7626\u8eab\u52301000\u5b57\u5185" : r = !0, r || (n.parent().prev().prev()[0].focus(), e.tipTxt = i, o("tipBox", n.parent()), e.tipTxt = "", setTimeout(function() {
            n.parent().find(".submit-tip").hide()
        }, 3e3)), r) : (e.lastInput = s, P.showIframe({
            page: "login"
    ...
    function a(t) {
        ...
        if (1 === r.code) {
            ...
            U[D.tab].child(0).show().prepend(S.tie.newTrunkNode(a ? a.id : "", c)), n.parentId ? (v(x.extend(u, {
                type: "reply",
                area: 2,
                parentId: n.parentId
            })), e.reply = null, o("toolBar")) : (v(x.extend(u, {
                type: "addTie",
                area: 1
            })), o("tieBox", E)), U[D.tab].child(1).hide(), i(), s.boxTie = {}
        } else e.tipTxt = _.codeMsg[r.code], o("tipBox", x(e.submitBtn).parent()), e.tipTxt = "", setTimeout(function() {
    ...
    function l() {
        for (var e, t = [], n = C.tabs, i = 0, o = C.tabs.length; i < o; i++) e = n[i], e.state && t.push(e);
        C.tabs = t, D.tab = "\u6700\u70ed" === C.tabs[0].tabName ? _.tabItem.hot : _.tabItem.xin
    }

    function u(e) {
        e.customized && (D.hot.size = D.xin.size = D.hot.load.step = D.xin.load.step = e.customSize), /\.k618\.cn$/.test(document.domain) && (D.hot.size = D.xin.size = D.hot.load.step = D.xin.load.step = 5)
    }

    function d(e) {
        return e ? void(x.isArray(e) && (W[D.tab] = W[D.tab] || {}, W[D.tab][D[D.tab].current] = e)) : W[D.tab] && W[D.tab][D[D.tab].current]
    }

    function p(e) {
        if (I) {
            var t = I.tab;
            if (!e) return W[t] && W[t][I[t].current];
            x.isArray(e) && (W[t] = W[t] || {}, W[t][I[t].current] = e)
        }
    }
    ...
    function h(e, t) {
        var n = D[D.tab],
            ...
            r = e.child(2),
            a = e.child(3);
        0 === t.length ? o.show() : (o.hide(), 1 === n.current && n.count > n.load.step ? (n.load.flag < n.size ? (t = t.slice(n.load.flag, n.load.flag += n.load.step), i.append(S.tie.buildView(t))) : i.html(S.tie.buildView(t)), n.load.flag < n.size && n.load.flag < n.count ? r.show() : (r.hide(), a.show().html(x.render(k.pagingTpl, n)))) : (i.html(S.tie.buildView(t)), a.show().html(x.render(k.pagingTpl, n))), i.show())
    }

    function f(t) {
        var i, o, r = D[D.tab];
        return t && 500 === t.code ? void(e.errorCount ? e.errorCount = void 0 : (e.errorCount = 1, n({
            action: "getList",
            pageNum: r.current,
            pageSize: r.size,
            tab: D.tab
        }))) : void(t && 1 === t.code ? (i = t.data, r.count = i.size, r.total = Math.ceil(i.size / r.size), i = S.tie.adaptData(i), d(i), h(U[D.tab], i)) : (U[D.tab].show().siblings().hide(), o = d(), o && o.length > 0 ? h(U[D.tab], o) : n({
            action: "getList",
            pageNum: r.current,
            pageSize: r.size,
            tab: D.tab
    ...
    function g() {
        l(), E.prepend(x.render(k.mainTpl)), /*C.skinId = C.skinId ? C.skinId : 1, x.loadCSS(_.skins[C.skinId].css),*/ U[_.tabItem.xin] = E.child(3).child(0), U[_.tabItem.hot] = E.child(3).child(1), f()
    }

    function m() {
        x(".cloud-tie-join-count .join-count").html(C.activeNum), x(".cloud-tie-join-count").bind("click", function(e) {
    ...
    function y(t) {
        if (c(t)) {
            if (x.extend(C, _.defaultConfig, window.cloudTieConfig, t.data), x.extend(C, {
                    ...
                    page: D,
                    isSPEC: !1
                }), !C.cloudSwitch || !C.totalSwitch) return !1;
            e.getUserInfo(), v({
                type: "threadCheckApi"
            }), g(), C.needCrawler && e.third.extractor.parse(function(e) {
                n({
                    action: "extractEssay",
                    title: e.title,
                    content: e.content,
    ...
    function b(t) {
        ...
        }, I.userNO = t, U.cmnt = z.child(2), U.tip = z.child(3), U.tipNum = z.child(1).find(".tip-num"), z.find(".tie-list").empty(), z.bind("scroll", function(t) {
            e._share || (o("shareBtn"), e.share.hide())
        });
    ...
    function w(e) {
        ...
        if (1 === e.code) {
            ...
            p(n), U[t].show().child(0).append(S.tie.buildView(n, "foldAll")), I[t].loaded += e.data.commentIdsAndDocId.length, I[t].total = e.data.total, I[t].total > 0 ? I[t].loaded < I[t].total && e.data.commentIdsAndDocId.length > 0 ? U[t].child(1).show() : (U[t].child(1).hide(), U[t].child(2).show()) : U[t].child(3).show()
        }
    }
    ...
    function T() {
        if (z) {
            ...
            z.css({
                ...
                marginTop: -i / 2 + "px",
                marginLeft: -n / 2 + "px"
            }), z.child(2).height(i - 200), z.child(3).height(i - 200)
        }
    }
    var I, x = e.tool,
        k = e.tpl,
    ...
    j.test(window.location.href) && (O = window.location.href.match(j)[2], "qa" === O && (O = "qaapi"), L = "https://" + O + ".gentie.163.com/pc/inner.html", /local/.test(O) && (L = "http://dev.f2e.gentie.163.com/tie/yun/sdk_dev/pc/inner.html"), /dev/.test(O) && (L = "inner.html?dev")), cloudTieConfig.dataApi && (L = cloudTieConfig.dataApi + "/pc/inner.html"), e.view = {};
    var A, z, E = e.view.wrapper = x("#" + window.cloudTieConfig.target).append(x.render(k.layout, {
            src: L
        })).child(0),
        U = {},
        R = x("#yun-tie-data-ifrm-923"),
        B = R[0].contentWindow,
        P = t();
    x("[id^='x-URS']").on("click", "[id^='x-discover']", function() {
        P.closeIframe(), N.delCls("z-lock-scroll")
    }), e.view.sendMsg = n;
    var H = !0;
    ...
    var W = {};
    e.cache = d, S.tie.cache = d, e.getUserInfo = function() {
        n({
            action: "userInfo"
        })
    }, e.stat = v;
    var q = e.controller.create({
        init: function(t) {
            this.el = t, this.boxTie = {}, this.delegateEvents(["click", "focus", "blur", "keyup", "stat"]), x(document.body).on("click", function(t) {
                e._share || (o("shareBtn"), e.share.hide())
            })
        },
        hideInputTip: function(e, t, n) {
            var i = x(this).parent();
            i.child(0)[0].focus(), i.addCls("z-fcs"), n && i.parent().prev().find(".arrow").addCls("z-fcs")
        },
        showInputTip: function(e, t, n) {
            var i = x(this).parent();
            x.trim(x(this).val()) || (i.delCls("z-fcs"), n && i.parent().prev().find(".arrow").delCls("z-fcs"))
        },
        submitTie: function(t, i, o) {
            var a = this,
                s = i.boxTie,
                c = o ? G(o) : null;
            e.submitBtn = a, e.submitScope = i, c && (s.parentId = c.commentId), e.userInfo && e.userInfo.isWeibo && x.cookie.get(_.cookie.syncWeibo) && x.extend(s, {
                type: 1,
                essayUrl: C.essayUrl,
                essayTitle: C.essayTitle
            }), s.content = s.content || e.lastInput, r(s, x(this)) ? n({
                action: "submitTie",
                boxTie: s,
                replyTie: c
            }) : i.boxTie = {}
        ...
        expandMdlFlr: function(e, t, n, i) {
            ...
            setTimeout(function() {
                o.before(S.tie.buildTrunkNode(a, "on")), o.remove()
            }, 50)
        },
        buildReplyBox: function(t, n, i) {
            var r = G(i);
            e.reply = r === e.reply ? null : r, setTimeout(function() {
                o("toolBar"), e.reply && E.find("textarea")[1].focus()
            }, 20)
        },
        upTie: function(e, t, i) {
            ...
            r.uped || (n({
                ...
                r.uped = !0, r.up++, o("upTie:" + i), r.upOver = !0, v({
                    type: "vote",
                    area: 2,
        ...
        downTie: function(e, t, i) {
            ...
            r.downed || (n({
                ...
                r.downed = !0, r.down++, o("downTie:" + i), r.downOver = !0, v({
                    type: "down",
                    area: 2,
                    commentId: r.commentId + "",
                    handleStatus: "true"
        ...
        shareWin: function(t, i, o) {
            var r = x(this),
                a = e._share = G(o);
            e._sharing = !0, e._shareTarget = r, n({
                action: "shareData",
                tie: a
            })
        },
        ...
        changePage: function(e, t, n) {
            var o = (x(e.target), D[D.tab]),
                n = parseInt(n) || 1;
            n > D.total && (n = D.total), n < 1 && (n = 1), o.current !== n && (o.current = n, f(), i())
        },
        stat: function(e, t, n) {
            n && v(n)
        },
        loginOut: function(t) {
            t.preventDefault(), "ssoUser" === e.userInfo.loginType ? x.getData({
                url: C.sso.logoutApi,
                jsonpCallback: "callback"
            }, function(e) {
                n({
        ...
        changeTab: function(e, t, n) {
            var i = x(this);
            n !== D.tab && (i.siblings().delCls("z-fcs"), i.addCls("z-fcs"), D.tab = n, f())
        },
        ...
        wbSyncSet: function(e, t) {
            x.cookie.get(_.cookie.syncWeibo) ? x.cookie.del(_.cookie.syncWeibo, "", "/") : x.cookie.set(_.cookie.syncWeibo, "1", "3y", "", "/"), o("userBar")
        },
        ...
        showIwin: function(t, n, i) {
            if (!e.iwin) {
                ...
                A = A || E.child(-3), z = z || E.child(-2), A.show(), z.show().html(x.render(k.ipageTpl, o ? o : {
                    userNO: r
                })), b(r), T(), N.addCls("z-lock-scroll"), e.pageI = I, e.iwin = !0
            }
        },
        closeIwin: function(t, n) {
            A.hide(), z.hide(), N.delCls("z-lock-scroll"), e.iwin = !1
        },
        ...
        changeItab: function(t, i, o) {
            var r, a = x(this);
            o !== I.tab && (a.siblings().delCls("z-fcs"), a.addCls("z-fcs"), U[I.tab].hide(), "tip" === I.tab && U.tipNum.hide(), I.tab = o, U[o].show(), r = I[I.tab].loaded / I.size + 1, I[I.tab].loaded <= 0 && n({
                action: "getIlist",
                pageNum: r,
                pageSize: I.size,
                tab: I.tab,
    ...
    new q(E), x(window).bind("message", function(t) {
        var n, i;
        if (t.source === B) {
            if (n = "object" == typeof t.data ? t.data : x.parseJSON(t.data), i = n.action, "initView" === i && y(n.config), "getList" === i && f(n.obj), "userInfo" === i) {
...
function(e) {
    window.define = e.define, e.define = void 0, window.__Tie && (window.Tie = window.__Tie)
}(window.Tie);